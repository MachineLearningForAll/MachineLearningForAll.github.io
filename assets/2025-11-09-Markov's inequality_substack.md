...
the expectation  exists. Markov's inequality provides
an upper bound on the probability  that
 exceeds a given positive threshold . In particular,
 This inequality can be verified by
noting that  is the expectation
 with the function
...
<figure id="fig">
 ...
 of a non-negative random variable (RV)
with probability distribution  can be obtained via Lebesgue
integral of  and ,
