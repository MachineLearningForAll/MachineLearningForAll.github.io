...
Academic service beyond my own university: examining doctoral theses at other universities, committee work at Aalto, and volunteer work against academic bullying.

### Doctoral thesis pre-examination

Pre-examiner (preliminary examiner) of doctoral dissertation manuscripts, appointed by the awarding faculty:

- **2026** · M. Tuononen, *"Towards Interpretable Machine Learning Models for the Physical Layer of 6G,"* School of Computing, University of Eastern Finland (FI).
- **2026** · S. Sheikhi, *"Trustworthy Distributed Intelligence for Security and Resilience in the Edge-Cloud Continuum,"* Faculty of Information Technology and Electrical Engineering, University of Oulu (FI).
- **2025** · A. Klemetti, *"Practical Approaches to Cost-Efficient Deep Learning: Taxonomy, Experiments, and Industry Insights,"* Faculty of Science, University of Helsinki (FI).
- **2024** · R. Savvides, *"Statistical Methods for Testing Visual Patterns, Selecting Models, and Bounding Model Errors,"* Faculty of Science, University of Helsinki (FI).

### Opponent, examiner, and grading committee
...
- Member of the **Teaching Evaluation Committee (SCITEC)** of the Aalto University School of Science. The committee evaluates the teaching portfolios of faculty across the school. I use the role to keep student well-being on the agenda alongside the usual metrics.
