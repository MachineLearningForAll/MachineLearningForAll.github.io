...
- **2021-11-05** · Online guest lesson on applications of machine learning in everyday services (music recommendation, web search, social media) for the advanced mathematics course MAA12 ([Scientists in Schools](https://www.aalto.fi/en/aalto-university-junior/scientists-in-schools) visit), Sibelius-lukio (upper secondary school), Helsinki (FI).
- **2020** · Guest lesson on applications of machine learning (music, web search, social media) for the advanced mathematics course MAA12, Sibelius-lukio (upper secondary school), Helsinki (FI).
- **2019** · Guest lesson on applications of machine learning for the advanced mathematics course MAA12, Sibelius-lukio (upper secondary school), Helsinki (FI).
